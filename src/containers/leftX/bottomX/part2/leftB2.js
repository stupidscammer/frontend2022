    ...
    <div className='w-full' >
        ...
        <div className='w-full flex flex-row pt-4 pr-10  items-stretch'>
            ...
            <div className='w-3/6  h-auto self-center'>
                <label className=' text-white text-4xl pl-10 '>1 Servings</label>
            </div>
            <div className='w-1/6 pr-2'>
                <button className='w-full h-full bg-[#548D01] text-4xl text-white hover:bg-[#7CD900] hover:shadow-xl rounded'>+</button>
            </div>
            <div className='w-1/6 pl-2 pr-2'>
                <button className='w-full h-full bg-[#EF5458] text-4xl text-white hover:bg-[#FE8683] rounded'>-</button>
            </div>
        </div>
    </div>
</div>
